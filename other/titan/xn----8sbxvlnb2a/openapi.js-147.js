  ...
  if (!VK.App) {
    VK.App = {
      ...
      _openApp: function (url, params) {
        ...
        domain = VK._base_domain || 'http://vk.com/js/api/vk.com';
        ...
        box = VK.Util.Box(src, {}, {
          closeExternalApp: function() {
            if (VK.App._result) {
              VK.Observer.publish('http://vk.com/js/api/app.done', VK.App._result);
              VK.App._result = null;
            } else {
          ...
          externalAppDone: function (params, noCloseLayer) {
            if (noCloseLayer) {
              ...
              VK.Observer.publish('http://vk.com/js/api/app.done', params);
              box.hide();
              VK.App._appOpened = false;
              VK.App._result = null;
            }
...
if (!VK.Widgets) {
  ...
  VK.Widgets.App = function(objId, app_id, options) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_app.php', objId, options, params, {}, {
  ...
  VK.Widgets.Article = function(id, url, options) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_article.php', id, options, params, {
